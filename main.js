...
/*
=================================================
START: Download Button JavaScript (FINAL-FINAL Version)
(This version uses a reliable reset for the download link)
=================================================
*/

document.querySelectorAll('.button.cv-button').forEach(button => {
    ...
    // Flag to ensure we don't try to download prematurely
    let isDownloading = false;

    // --- Helper function to reset the button animation ---
    const resetButton = () => {
    ...
    button.addEventListener('click', function(e) {
        ...
        // Block all clicks if currently animating
        if (button.classList.contains('loading') || isDownloading) {
            e.preventDefault();
            return;
        }

        // --- PHASE 1: START ANIMATION AND BLOCK DOWNLOAD ---
        e.preventDefault(); // Block the immediate download
        isDownloading = true; 
        ...
        // --- PHASE 2: TRIGGER DOWNLOAD AFTER ANIMATION ---
        setTimeout(() => {
            // 1. Get original URL
            const downloadUrl = button.getAttribute('href');
            const downloadName = button.getAttribute('download');
            
            // 2. Create and click the invisible link (most reliable method)
            ...
            // 3. Reset the button after a slight delay to allow the download to start
...
/*
=================================================
END: Download Button JavaScript
=================================================
*/
